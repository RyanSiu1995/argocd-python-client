...
class VersionServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.version_service_version = _Endpoint(
            settings={
                'response_type': (VersionVersionMessage,),
                'auth': [],
                'endpoint_path': '/api/version',
                'operation_id': 'version_service_version',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__version_service_version
        )
