...
class V1alpha1ApplicationSpec(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'destination': (V1alpha1ApplicationDestination,),  # noqa: E501
            'ignore_differences': ([V1alpha1ResourceIgnoreDifferences],),  # noqa: E501
            'info': ([V1alpha1Info],),  # noqa: E501
            'project': (str,),  # noqa: E501
            'revision_history_limit': (str,),  # noqa: E501
            'source': (V1alpha1ApplicationSource,),  # noqa: E501
            'sync_policy': (V1alpha1SyncPolicy,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V1alpha1ApplicationSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            destination (V1alpha1ApplicationDestination): [optional]  # noqa: E501
            ignore_differences ([V1alpha1ResourceIgnoreDifferences]): [optional]  # noqa: E501
            info ([V1alpha1Info]): [optional]  # noqa: E501
            project (str): Project is a reference to the project this application belongs to. The empty string means that application belongs to the 'default' project.. [optional]  # noqa: E501
            revision_history_limit (str): RevisionHistoryLimit limits the number of items kept in the application's revision history, which is used for informational purposes as well as for rollbacks to previous versions. This should only be changed in exceptional circumstances. Setting to zero will store no history. This will reduce storage used. Increasing will increase the space used to store the history, so we do not recommend increasing it. Default is 10.. [optional]  # noqa: E501
            source (V1alpha1ApplicationSource): [optional]  # noqa: E501
            sync_policy (V1alpha1SyncPolicy): [optional]  # noqa: E501
        """
