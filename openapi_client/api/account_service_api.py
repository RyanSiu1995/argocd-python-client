...
class AccountServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.account_service_can_i = _Endpoint(
            settings={
                'response_type': (AccountCanIResponse,),
                'auth': [],
                'endpoint_path': '/api/v1/account/can-i/{resource}/{action}/{subresource}',
                'operation_id': 'account_service_can_i',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__account_service_can_i
        )

        def __account_service_create_token(
            self,
            name,
            body,
            **kwargs
            ...
            >>> thread = api.account_service_create_token(name, body, async_req=True)
            >>> result = thread.get()
        ...
        self.account_service_create_token = _Endpoint(
            settings={
                'response_type': (AccountCreateTokenResponse,),
                'auth': [],
                'endpoint_path': '/api/v1/account/{name}/token',
                'operation_id': 'account_service_create_token',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__account_service_create_token
        )

        def __account_service_delete_token(
            self,
            name,
            id,
            **kwargs
        ...
        self.account_service_delete_token = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/account/{name}/token/{id}',
                'operation_id': 'account_service_delete_token',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__account_service_delete_token
        )

        def __account_service_get_account(
            self,
            name,
            **kwargs
        ):
        ...
        self.account_service_get_account = _Endpoint(
            settings={
                'response_type': (AccountAccount,),
                'auth': [],
                'endpoint_path': '/api/v1/account/{name}',
                'operation_id': 'account_service_get_account',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__account_service_get_account
        )

        def __account_service_list_accounts(
            self,
            **kwargs
        ):
        ...
        self.account_service_list_accounts = _Endpoint(
            settings={
                'response_type': (AccountAccountsList,),
                'auth': [],
                'endpoint_path': '/api/v1/account',
                'operation_id': 'account_service_list_accounts',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__account_service_list_accounts
        )

        def __account_service_update_password(
            self,
            body,
            **kwargs
        ):
        ...
        self.account_service_update_password = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/account/password',
                'operation_id': 'account_service_update_password',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__account_service_update_password
        )
